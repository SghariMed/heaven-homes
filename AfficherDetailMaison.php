...
session_start();
    $MaisonC=new MaisonC();
        ...
        $fidelitee=$FideliteC->recupererfedilite_user_maison($_SESSION['id'],$_GET['id']);
    if (sizeof($fidelitee) == 0) {
        $fedilite= new fedilite(0,5,$_SESSION['id'],$_GET['id']);
       $FideliteC->ajoutFidelite($fedilite);
    }
